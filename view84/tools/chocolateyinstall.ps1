...
#   url64bit      = $url64
  ...
  # softwareName  = 'view84*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
D:\choco-dependence\view84\tools\view84code.ps1
