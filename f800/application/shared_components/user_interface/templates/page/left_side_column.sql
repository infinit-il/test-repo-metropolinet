...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1648520011002109)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1648840774002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1649125799002109)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1649424553002109)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1649738136002109)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1650012425002109)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1650390797002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1650678557002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1650909506002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1651272749002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1651568268002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1651819309002110)
,p_page_template_id=>wwv_flow_imp.id(1648520011002109)
