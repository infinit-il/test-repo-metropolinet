...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1667708477002115)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1668059021002117)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1668338814002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1668657288002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1668996501002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1669260359002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1669587417002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1669892273002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1670197365002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1670402009002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1670751011002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1671037471002117)
,p_page_template_id=>wwv_flow_imp.id(1667708477002115)
