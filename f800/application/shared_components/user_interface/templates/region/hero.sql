...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1714519262002132)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1714845674002132)
,p_plug_template_id=>wwv_flow_imp.id(1714519262002132)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1715134231002132)
,p_plug_template_id=>wwv_flow_imp.id(1714519262002132)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1715444935002132)
,p_plug_template_id=>wwv_flow_imp.id(1714519262002132)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1715782396002132)
,p_plug_template_id=>wwv_flow_imp.id(1714519262002132)
,p_name=>'Sub Regions'
