...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1764749761002150)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1765071786002150)
,p_plug_template_id=>wwv_flow_imp.id(1764749761002150)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1765351156002150)
,p_plug_template_id=>wwv_flow_imp.id(1764749761002150)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1765620428002150)
,p_plug_template_id=>wwv_flow_imp.id(1764749761002150)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1765915566002150)
,p_plug_template_id=>wwv_flow_imp.id(1764749761002150)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1766245894002150)
,p_plug_template_id=>wwv_flow_imp.id(1764749761002150)
