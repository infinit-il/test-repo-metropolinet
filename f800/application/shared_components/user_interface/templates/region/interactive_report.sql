...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1737796898002140)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1738089845002140)
,p_plug_template_id=>wwv_flow_imp.id(1737796898002140)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1738372934002140)
,p_plug_template_id=>wwv_flow_imp.id(1737796898002140)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1738638529002140)
,p_plug_template_id=>wwv_flow_imp.id(1737796898002140)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1738994897002140)
,p_plug_template_id=>wwv_flow_imp.id(1737796898002140)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1739273088002140)
,p_plug_template_id=>wwv_flow_imp.id(1737796898002140)
,p_name=>'Sub Regions'
