...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1681556816002121)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1681830052002121)
,p_plug_template_id=>wwv_flow_imp.id(1681556816002121)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1682110543002121)
,p_plug_template_id=>wwv_flow_imp.id(1681556816002121)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1682417630002121)
,p_plug_template_id=>wwv_flow_imp.id(1681556816002121)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1682734843002121)
,p_plug_template_id=>wwv_flow_imp.id(1681556816002121)
,p_name=>'Sub Regions'
