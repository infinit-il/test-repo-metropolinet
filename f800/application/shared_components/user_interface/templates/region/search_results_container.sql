...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1744872279002142)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1745157997002142)
,p_plug_template_id=>wwv_flow_imp.id(1744872279002142)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1745469131002142)
,p_plug_template_id=>wwv_flow_imp.id(1744872279002142)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1745700915002143)
,p_plug_template_id=>wwv_flow_imp.id(1744872279002142)
,p_name=>'Sub Regions'
