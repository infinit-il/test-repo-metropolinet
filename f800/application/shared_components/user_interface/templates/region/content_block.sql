...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1709946470002131)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1710214258002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1710562710002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1710882506002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1711171103002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1711430855002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1711716482002131)
,p_plug_template_id=>wwv_flow_imp.id(1709946470002131)
,p_name=>'Sub Regions'
