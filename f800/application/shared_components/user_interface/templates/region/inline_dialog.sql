...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1723133945002135)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1723434447002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1723726405002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1724048951002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1724346837002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1724679484002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1724957441002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1725218831002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1725512892002135)
,p_plug_template_id=>wwv_flow_imp.id(1723133945002135)
,p_name=>'Sub Regions'
