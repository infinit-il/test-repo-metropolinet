...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1732397872002139)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1732610542002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1732909033002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1733251441002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1733556316002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1733882681002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1734175018002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1734426680002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1734773013002139)
,p_plug_template_id=>wwv_flow_imp.id(1732397872002139)
,p_name=>'Sub Regions'
