...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1688675330002123)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1688950669002123)
,p_plug_template_id=>wwv_flow_imp.id(1688675330002123)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1689216067002123)
,p_plug_template_id=>wwv_flow_imp.id(1688675330002123)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1689579342002123)
,p_plug_template_id=>wwv_flow_imp.id(1688675330002123)
,p_name=>'Sub Regions'
