...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1717733376002132)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1718016642002134)
,p_plug_template_id=>wwv_flow_imp.id(1717733376002132)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1718387190002134)
,p_plug_template_id=>wwv_flow_imp.id(1717733376002132)
,p_name=>'Sub Regions'
