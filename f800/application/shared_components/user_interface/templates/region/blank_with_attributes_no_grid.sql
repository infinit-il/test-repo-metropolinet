...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1682948247002121)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1683218298002121)
,p_plug_template_id=>wwv_flow_imp.id(1682948247002121)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1683501080002121)
,p_plug_template_id=>wwv_flow_imp.id(1682948247002121)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1683881054002121)
,p_plug_template_id=>wwv_flow_imp.id(1682948247002121)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1684127690002121)
,p_plug_template_id=>wwv_flow_imp.id(1682948247002121)
,p_name=>'Sub Regions'
