...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1739816624002140)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740155040002140)
,p_plug_template_id=>wwv_flow_imp.id(1739816624002140)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740408165002140)
,p_plug_template_id=>wwv_flow_imp.id(1739816624002140)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1740791004002140)
,p_plug_template_id=>wwv_flow_imp.id(1739816624002140)
,p_name=>'Button Start'
