...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1757366580002146)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1757641552002146)
,p_plug_template_id=>wwv_flow_imp.id(1757366580002146)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1757917169002146)
,p_plug_template_id=>wwv_flow_imp.id(1757366580002146)
,p_name=>'Tabs'
