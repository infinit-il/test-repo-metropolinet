...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1742332358002142)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742693968002142)
,p_plug_template_id=>wwv_flow_imp.id(1742332358002142)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1742986972002142)
,p_plug_template_id=>wwv_flow_imp.id(1742332358002142)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743206828002142)
,p_plug_template_id=>wwv_flow_imp.id(1742332358002142)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743570079002142)
,p_plug_template_id=>wwv_flow_imp.id(1742332358002142)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1743812108002142)
,p_plug_template_id=>wwv_flow_imp.id(1742332358002142)
,p_name=>'Sub Regions'
