...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1727770198002137)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1728084948002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1728313518002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1728603760002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1728944652002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1729206702002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1729581526002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1729816669002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1730154508002137)
,p_plug_template_id=>wwv_flow_imp.id(1727770198002137)
,p_name=>'Sub Regions'
