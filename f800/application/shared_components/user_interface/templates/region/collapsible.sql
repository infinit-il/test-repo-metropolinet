...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1700422169002128)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1700755958002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1701073740002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1701355687002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1701601393002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1701946352002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1702284125002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1702551679002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1702882187002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(1703109929002128)
,p_plug_template_id=>wwv_flow_imp.id(1700422169002128)
,p_name=>'Sub Regions'
