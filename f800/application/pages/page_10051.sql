...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1991070933002443)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1990963348002443)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1991070933002443)
,p_button_name=>'CLOSE'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1991145642002443)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1990963348002443)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(2002989694002450)
,p_event_id=>wwv_flow_imp.id(1991145642002443)
,p_event_result=>'TRUE'
