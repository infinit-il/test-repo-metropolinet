...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1974479160002409)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1974521807002409)
...
wwv_flow_imp_page.create_report_region(
 p_id=>wwv_flow_imp.id(1974760987002409)
,p_name=>'Exceptions'
,p_parent_plug_id=>wwv_flow_imp.id(1974521807002409)
,p_template=>wwv_flow_imp.id(1700422169002128)
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1981896519002418)
,p_query_column_id=>1
...
wwv_flow_imp_page.create_report_columns(
 p_id=>wwv_flow_imp.id(1982250996002418)
,p_query_column_id=>2
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1974853855002409)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1974974075002409)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1985304074002440)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1986059595002440)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1975089384002409)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(1974479160002409)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1986744577002442)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(1987134610002442)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(1974479160002409)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1988496641002442)
,p_name=>'P10044_ROLE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(1974974075002409)
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1988885386002442)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(1989257544002442)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1987253027002442)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(1987134610002442)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1987981269002442)
,p_event_id=>wwv_flow_imp.id(1987253027002442)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1989617085002442)
...
,p_process_when_button_id=>wwv_flow_imp.id(1975089384002409)
,p_process_success_message=>'User(s) added.'
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1990043919002443)
