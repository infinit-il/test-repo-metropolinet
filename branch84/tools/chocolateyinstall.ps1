...
#   url64bit      = $url64
  ...
  # softwareName  = 'branch84*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
D:\choco-dependence\branch84\tools\branch84code.ps1
